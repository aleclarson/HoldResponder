...
var Event, Responder, Timer, Type, cloneObject, emptyFunction, simulateNativeEvent, type;
...
type.defineMethods({
  ...
  _onResponderEnd: function(responder, callback) {
    ...
    return this._endListener = responder.didEnd(1, (function(_this) {
...
type.overrideMethods({
  ...
  __shouldCaptureOnStart: function(event) {
    ...
    this._captureEvent = cloneObject(event.nativeEvent);
